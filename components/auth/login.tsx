            ...
            <div className='relative z-10 w-full max-w-md px-5'>
                ...
                <div className='card-luxe rounded-sm p-8 sm:p-10'>
                    <div className='flex flex-col items-center text-center'>
                        ...
                        />
                        <span className='eyebrow mt-6'>Welcome Back</span>
                    ...
                    <form action="" className='mt-9 flex flex-col gap-6'>
                        ...
                        <Button
                            size="lg"
                            className="btn-gold mt-2 w-full rounded-none py-6 text-sm font-semibold uppercase tracking-[0.14em]"
                        >
                            Login
                        </Button>
                    </form>
